...
@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, modid = DimensionalControlNeo.MOD_ID)
    ...
    public static void onRegisterSerializers(RegisterEvent event) {
        event.register(
                ...
                helper -> helper.register(
                        ResourceLocation.fromNamespaceAndPath(DimensionalControlNeo.MOD_ID, GlobalLootModifier.Name),
